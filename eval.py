...
class YoloTest(object):
    def __init__(self):
        ...
        self.annotation_path  = 'annotation/voc2012_val.txt'
        ...
        self._decode = Decode(inputs, 0.3, 0.45, self.input_shape, 'ep000130-loss3.803-val_loss9.104.pd', self.file, initial_filters=8, use_gpu=use_gpu)
