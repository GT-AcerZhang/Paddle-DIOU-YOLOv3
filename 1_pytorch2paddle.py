...
#
#   Author      : miemie2013
#   Created date: 2020-01-19 15:24:37
#   Description : 将pytorch模型导出为paddle模型。
#
#================================================================
...
with fluid.program_guard(train_program, startup_program):
    ...
    y1, y2, y3 = YOLOv3(inputs, initial_filters=32, num_classes=80, is_test=False)

place = fluid.CPUPlace()
exe = fluid.Executor(place)
exe.run(startup_program)

net = Darknet(num_classes=80, initial_filters=32)
net.load_state_dict(torch.load('yolo_bgr_mAP_47.pt'))
net.eval()  # 必须调用model.eval()来设置dropout和batch normalization layers在运行推理前，切换到评估模式. 不这样做的化会产生不一致的推理结果.



def aaaaaaa(k, cccccccc, place):
...
def bbbbbbb(k, stack_residual_block, place):
    i = 0
    for residual_block in stack_residual_block.sequential:
        conv1 = residual_block.conv1
        conv2 = residual_block.conv2
        aaaaaaa(k+i+1, conv1, place)
        aaaaaaa(k+i+2, conv2, place)
        i += 2


aaaaaaa(1, net.conv1, place)
aaaaaaa(2, net.conv2, place)
aaaaaaa(5, net.conv3, place)
aaaaaaa(10, net.conv4, place)
aaaaaaa(27, net.conv5, place)
aaaaaaa(44, net.conv6, place)
aaaaaaa(53, net.conv53, place)
aaaaaaa(54, net.conv54, place)
aaaaaaa(55, net.conv55, place)
aaaaaaa(56, net.conv56, place)
aaaaaaa(57, net.conv57, place)
aaaaaaa(58, net.conv58, place)
aaaaaaa2(59, net.conv59, place)
aaaaaaa(60, net.conv60, place)
aaaaaaa(61, net.conv61, place)
aaaaaaa(62, net.conv62, place)
aaaaaaa(63, net.conv63, place)
aaaaaaa(64, net.conv64, place)
aaaaaaa(65, net.conv65, place)
aaaaaaa(66, net.conv66, place)
aaaaaaa2(67, net.conv67, place)
aaaaaaa(68, net.conv68, place)
aaaaaaa(69, net.conv69, place)
aaaaaaa(70, net.conv70, place)
aaaaaaa(71, net.conv71, place)
aaaaaaa(72, net.conv72, place)
aaaaaaa(73, net.conv73, place)
aaaaaaa(74, net.conv74, place)
aaaaaaa2(75, net.conv75, place)

bbbbbbb(2, net.stack_residual_block_1, place)
bbbbbbb(5, net.stack_residual_block_2, place)
bbbbbbb(10, net.stack_residual_block_3, place)
bbbbbbb(27, net.stack_residual_block_4, place)
bbbbbbb(44, net.stack_residual_block_5, place)


fluid.io.save_persistables(exe, 'aaa', train_program)
